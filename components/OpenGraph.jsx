...
export const OpenGraph = () => {
  ...
  return (
    <Head>
      ...
      <meta property="og:url" content={"https://sendhyrama.github.io"} key="ogurl" />
      <meta property="og:type" content="website" />
      <meta property="og:title" content={"Sendhyrama's Web"} key="ogtitle" />
      <meta property="og:site_name" content={"Sendhyrama's Web"} key="ogsitename" />
